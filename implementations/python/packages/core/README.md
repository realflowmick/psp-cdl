...
Status: **experimental reusable library**. Bounded PSP markup, document objects, JSON, signatures and host-scoped verification. Cryptography has a separate module; codec imports do not start services.
