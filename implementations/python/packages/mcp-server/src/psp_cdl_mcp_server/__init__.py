...
_MANIFEST = {'id': 'mcp-server', 'status': 'experimental', 'specifications': {'psp': '3.2.0', 'cdl': '1.5'}, 'implementedFeatures': ['mcp-security-tools-0.1', 'mcp-stdio-2025-11-25', 'mcp-workflow-tools-0.1', 'host-tool-service-adapter', 'mcp-streamable-http-0.1']}
