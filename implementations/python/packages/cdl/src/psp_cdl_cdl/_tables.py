...
# Generated from conformance/policy; verified by library tests.
TABLE = {'profile': 'CDL-DETERMINISTIC-1.0',
 'version': '1.0',
 ...
 'classes': ['ai-assisted',
             ...
             'synthetic-media',
             'taboo-information'],
 'capabilities': ['42-cfr-part-2-compliant',
 ...
 'rules': [{'id': 'class:ai-high-risk',
           ...
           {'id': 'covenant:no-extract',
            'kind': 'covenant',
            'term': 'no-extract',
            'conflictAny': ['can-extract']},
           {'id': 'covenant:no-government-disclosure',
            'kind': 'covenant',
            'term': 'no-government-disclosure',
            'conflictAny': ['discloses-to-government']},
           {'id': 'covenant:no-index',
            'kind': 'covenant',
            'term': 'no-index',
            'conflictAny': ['can-index']},
           {'id': 'covenant:no-log',
            'kind': 'covenant',
            'term': 'no-log',
            'conflictAny': ['creates-audit-trail',
                            'logs-data',
                            'logs-display-events',
                            'logs-operations']},
 ...
 'implications': {'can-cache': ['persists-data'],
                  'can-call-external-api': ['can-transmit-externally'],
                  'can-create-audit-trail': ['creates-audit-trail'],
                  'can-display-to-operator': ['can-display'],
                  'can-post-to-web': ['can-transmit-externally'],
                  'can-send-email': ['can-transmit-externally'],
                  'can-send-sms': ['can-transmit-externally'],
                  'can-write-database': ['can-write-storage'],
                  'can-write-filesystem': ['can-write-storage'],
                  'can-write-storage': ['persists-data'],
                  'collects-data': ['persists-data'],
                  'collects-derived-only': ['persists-data'],
                  'creates-audit-trail': ['persists-data'],
                  'creates-embeddings': ['persists-data'],
                  'displays-raw-data': ['can-display-to-operator'],
                  'indexes-for-rag': ['can-index', 'persists-data'],
                  'is-gpai-model': ['is-ai-system'],
                  'is-high-risk-ai': ['is-ai-system'],
                  'logs-data': ['persists-data'],
                  'logs-display-events': ['persists-data'],
                  'logs-operations': ['persists-data'],
                  'verifies-agreement-baa': ['verifies-agreement'],
                  'verifies-agreement-dua': ['verifies-agreement'],
                  'verifies-agreement-mou': ['verifies-agreement']},
 'reasonStages': [['INVALID_DECLARATION', 'LIMIT_EXCEEDED', 'CONTRADICTORY_DECLARATION'],
                  ['UNSUPPORTED_TERM', 'UNSUPPORTED_SCHEMA'],
                  ['UNTRUSTED_DECLARATION',
                   'SCOPE_MISMATCH',
                   'STALE_CONTEXT',
                   'INCOMPLETE_CAPABILITIES',
                   'INVALID_CONTEXT'],
                  ['INVALID_NEGATION', 'UNAUTHORIZED_NEGATION'],
                  ['TOPOLOGY_INSUFFICIENT', 'MEDIATION_INCOMPLETE'],
                  ['PROCESSING_PROHIBITED', 'CAPABILITY_CONFLICT'],
                  ['MISSING_CONTEXT',
                   'ROLE_MISMATCH',
 ...
 'appendixCoverage': [{'section': 'B.2', 'row': 'no-persist', 'rules': ['covenant:no-persist']},
                      {'section': 'B.2', 'row': 'no-training', 'rules': ['covenant:no-training']},
                      {'section': 'B.2',
                       'row': 'no-external-transmission',
                       'rules': ['covenant:no-external-transmission']},
                      {'section': 'B.2', 'row': 'no-log', 'rules': ['covenant:no-log']},
                      {'section': 'B.2', 'row': 'no-cache', 'rules': ['covenant:no-cache']},
                      {'section': 'B.2',
                       'row': 'encryption-required',
                       'rules': ['covenant:encryption-required']},
                      {'section': 'B.2',
                       'row': 'no-display-to-operator',
                       'rules': ['covenant:no-display-to-operator']},
                      {'section': 'B.2',
                       'row': 'operator-blind-processing',
                       'rules': ['covenant:operator-blind-processing']},
                      {'section': 'B.2',
                       'row': 'redacted-display-only',
                       'rules': ['covenant:redacted-display-only']},
                      {'section': 'B.2',
                       'row': 'role-restricted-display',
                       'rules': ['covenant:role-restricted-display']},
                      {'section': 'B.2', 'row': 'no-collect', 'rules': ['covenant:no-collect']},
                      {'section': 'B.2',
                       'row': 'no-derived-collection',
                       'rules': ['covenant:no-derived-collection']},
                      {'section': 'B.2',
                       'row': 'no-government-disclosure',
                       'rules': ['covenant:no-government-disclosure']},
                      {'section': 'B.2',
                       'row': 'no-directory-listing',
                       'rules': ['covenant:no-directory-listing']},
                      {'section': 'B.2',
                       'row': 'no-disclosure-to-subject',
                       'rules': ['covenant:no-disclosure-to-subject']},
                      {'section': 'B.2',
                       'row': 'no-embedding-storage',
                       'rules': ['covenant:no-embedding-storage']},
                      {'section': 'B.2',
                       'row': 'no-rag-indexing',
                       'rules': ['covenant:no-rag-indexing']},
                      {'section': 'B.2',
                       'row': 'subject-authorization-required',
                       'rules': ['covenant:subject-authorization-required']},
                      {'section': 'B.2',
                       'row': 'agreement-required',
                       'rules': ['covenant:agreement-required']},
                      {'section': 'B.2',
                       'row': 'agreement-required-{type}',
                       'rules': ['covenant:agreement-required-baa',
                                 'covenant:agreement-required-dua',
                                 'covenant:agreement-required-mou'],
                       'resolution': 'Finite expansion: baa, dua and mou; other types are '
                                     'unsupported.'},
                      {'section': 'B.2',
                       'row': 'organizational-policy-required',
                       'rules': ['covenant:organizational-policy-required']},
                      {'section': 'B.2',
                       'row': 'consent-current-required',
                       'rules': ['covenant:consent-current-required']},
                      {'section': 'B.2',
                       'row': 'parental-consent-required',
                       'rules': ['covenant:parental-consent-required']},
                      {'section': 'B.2',
                       'row': 'professional-determination-required',
                       'rules': ['covenant:professional-determination-required']},
                      {'section': 'B.2',
                       'row': 'encryption-in-use',
                       'rules': ['covenant:encryption-in-use']},
                      {'section': 'B.2',
                       'row': 'de-identification-required',
                       'rules': ['covenant:de-identification-required']},
                      {'section': 'B.2',
                       'row': 'delete-after-use',
                       'rules': ['covenant:delete-after-use']},
                      {'section': 'B.2',
                       'row': 'within-jurisdiction-only',
                       'rules': ['covenant:within-jurisdiction-only']},
                      {'section': 'B.2', 'row': 'no-derive', 'rules': ['covenant:no-derive']},
                      {'section': 'B.2', 'row': 'no-aggregate', 'rules': ['covenant:no-aggregate']},
                      {'section': 'B.2', 'row': 'no-extract', 'rules': ['covenant:no-extract']},
                      {'section': 'B.2', 'row': 'no-index', 'rules': ['covenant:no-index']},
                      {'section': 'B.2',
                       'row': 'no-distribute',
                       'rules': ['covenant:no-distribute']},
                      {'section': 'B.2', 'row': 'no-share', 'rules': ['covenant:no-share']},
                      {'section': 'B.2', 'row': 'no-modify', 'rules': ['covenant:no-modify']},
                      {'section': 'B.2', 'row': 'no-transform', 'rules': ['covenant:no-transform']},
                      {'section': 'B.2', 'row': 'no-translate', 'rules': ['covenant:no-translate']},
                      {'section': 'B.2', 'row': 'no-print', 'rules': ['covenant:no-print']},
                      {'section': 'B.2', 'row': 'no-display', 'rules': ['covenant:no-display']},
                      {'section': 'B.2', 'row': 'no-execute', 'rules': ['covenant:no-execute']},
                      {'section': 'B.2',
                       'row': 'no-commercial-use',
                       'rules': ['covenant:no-commercial-use']},
                      {'section': 'B.2',
                       'row': 'no-secondary-use',
                       'rules': ['covenant:no-secondary-use']},
                      {'section': 'B.2', 'row': 'no-tracking', 'rules': ['covenant:no-tracking']},
                      {'section': 'B.2', 'row': 'no-profiling', 'rules': ['covenant:no-profiling']},
                      {'section': 'B.2',
                       'row': 'no-automated-decision-making',
                       'rules': ['covenant:no-automated-decision-making']},
                      {'section': 'B.2',
                       'row': 'attribution-required',
                       'rules': ['covenant:attribution-required']},
                      {'section': 'B.2',
                       'row': 'share-alike-required',
                       'rules': ['covenant:share-alike-required']},
                      {'section': 'B.2',
                       'row': 'lawful-basis-consent',
                       'rules': ['covenant:lawful-basis-consent']},
                      {'section': 'B.2',
                       'row': 'lawful-basis-contract',
                       'rules': ['covenant:lawful-basis-contract']},
                      {'section': 'B.2',
                       'row': 'lawful-basis-legitimate-interests',
                       'rules': ['covenant:lawful-basis-legitimate-interests']},
                      {'section': 'B.2',
                       'row': 'human-oversight-required',
                       'rules': ['covenant:human-oversight-required']},
                      {'section': 'B.2',
                       'row': 'transparency-disclosure-required',
                       'rules': ['covenant:transparency-disclosure-required']},
                      {'section': 'B.2',
                       'row': 'ai-generated-content-marked',
                       'rules': ['covenant:ai-generated-content-marked']},
                      {'section': 'B.2',
                       'row': 'explainable-ai-required',
                       'rules': ['covenant:explainable-ai-required']},
                      {'section': 'B.2',
                       'row': 'interpretable-ai-required',
                       'rules': ['covenant:interpretable-ai-required']},
                      {'section': 'B.2',
                       'row': 'fair-bias-managed-required',
                       'rules': ['covenant:fair-bias-managed-required']},
                      {'section': 'B.2',
                       'row': 'right-of-erasure',
                       'rules': ['covenant:right-of-erasure']},
                      {'section': 'B.2',
                       'row': 'right-of-access',
                       'rules': ['covenant:right-of-access']},
                      {'section': 'B.2',
                       'row': 'right-of-portability',
                       'rules': ['covenant:right-of-portability']},
                      {'section': 'B.2',
                       'row': 'ai-unacceptable-risk',
                       'rules': ['class:ai-unacceptable-risk']},
                      {'section': 'B.2', 'row': 'ai-high-risk', 'rules': ['class:ai-high-risk']},
                      {'section': 'B.3',
                       'row': 'audit-required',
                       'rules': ['covenant:audit-required']},
                      {'section': 'B.3',
                       'row': 'encryption-required',
                       'rules': ['covenant:encryption-required']},
                      {'section': 'B.3',
                       'row': 'encryption-in-use',
                       'rules': ['covenant:encryption-in-use']},
                      {'section': 'B.3', 'row': 'hipaa', 'rules': ['covenant:hipaa']},
                      {'section': 'B.3', 'row': 'gdpr', 'rules': ['covenant:gdpr']},
                      {'section': 'B.3',
                       'row': '42-cfr-part-2',
                       'rules': ['covenant:42-cfr-part-2']},
                      {'section': 'B.3', 'row': 'gina', 'rules': ['covenant:gina']},
                      {'section': 'B.3',
                       'row': 'role-based-access',
                       'rules': ['covenant:role-based-access']},
                      {'section': 'B.3', 'row': 'mfa-required', 'rules': ['covenant:mfa-required']},
                      {'section': 'B.3',
                       'row': 'redacted-display-only',
                       'rules': ['covenant:redacted-display-only']},
                      {'section': 'B.3',
                       'row': 'summary-only-display',
                       'rules': ['covenant:summary-only-display']},
                      {'section': 'B.3',
                       'row': 'role-restricted-display',
                       'rules': ['covenant:role-restricted-display']},
                      {'section': 'B.3',
                       'row': 'audit-on-display',
                       'rules': ['covenant:audit-on-display']},
                      {'section': 'B.3',
                       'row': 'subject-authorization-required',
                       'rules': ['covenant:subject-authorization-required']},
                      {'section': 'B.3',
                      ...
                      {'section': 'B.3',
                       ...
                       'rules': ['covenant:agreement-required-dua']},
                      {'section': 'B.3',
                       'row': 'agreement-required-mou',
                       'rules': ['covenant:agreement-required-mou']},
                      {'section': 'B.3',
                       'row': 'organizational-policy-required',
                       'rules': ['covenant:organizational-policy-required']},
                      {'section': 'B.3',
                      ...
                      {'section': 'B.3',
                       'row': 'no-collect',
                       'rules': ['covenant:no-collect'],
                       'resolution': 'Ingestion remains prohibited; transient-processing-only is '
                                     'not an exception.'},
                      {'section': 'B.3',
                       'row': 'no-derived-collection',
                       'rules': ['covenant:no-derived-collection']},
                      ...
                      {'section': 'B.3',
                       ...
                       'rules': ['covenant:lawful-basis-legal-obligation']},
                      {'section': 'B.3',
                       'row': 'lawful-basis-public-task',
                       'rules': ['covenant:lawful-basis-public-task']},
                      {'section': 'B.3',
                       'row': 'lawful-basis-legitimate-interests',
                       'rules': ['covenant:lawful-basis-legitimate-interests']},
                      {'section': 'B.3',
                      ...
                      {'section': 'B.3',
                       ...
                       'rules': ['covenant:valid-and-reliable-required']},
                      {'section': 'B.3',
                       'row': 'safe-ai-required',
                       'rules': ['covenant:safe-ai-required']},
                      {'section': 'B.3',
                       'row': 'secure-resilient-ai-required',
                       'rules': ['covenant:secure-resilient-ai-required']},
                      {'section': 'B.3',
                       'row': 'accountable-transparent-ai-required',
                       'rules': ['covenant:accountable-transparent-ai-required']},
                      {'section': 'B.3',
                       'row': 'explainable-ai-required',
                       'rules': ['covenant:explainable-ai-required']},
                      {'section': 'B.3',
                      ...
                      {'section': 'B.3',
                       ...
                       'rules': ['covenant:privacy-enhanced-ai-required']},
                      {'section': 'B.3',
                       'row': 'fair-bias-managed-required',
                       'rules': ['covenant:fair-bias-managed-required']},
                      {'section': 'B.3',
                       'row': 'risk-management-system-required',
                       'rules': ['covenant:risk-management-system-required']},
                      {'section': 'B.3',
                       'row': 'conformity-assessment-required',
                       'rules': ['covenant:conformity-assessment-required']},
                      {'section': 'B.3',
                       'row': 'attribution-required',
                       'rules': ['covenant:attribution-required']},
                      {'section': 'B.3',
                      ...
                      {'section': 'B.3',
                       ...
                       'rules': ['covenant:right-of-rectification']},
                      {'section': 'B.3',
                       'row': 'right-to-object',
                       'rules': ['covenant:right-to-object']},
                      {'section': 'B.3', 'row': 'eu-ai-act', 'rules': ['covenant:eu-ai-act']},
                      {'section': 'B.3',
                       'row': 'iso-iec-42001',
                       'rules': ['covenant:iso-iec-42001']},
                      {'section': 'B.3',
                       'row': 'iso-iec-27001',
                       'rules': ['covenant:iso-iec-27001']},
                      {'section': 'B.3', 'row': 'nist-ai-rmf', 'rules': ['covenant:nist-ai-rmf']}]}
ENFORCEMENT = {'profile': 'PSP-TRUST-1.0',
 'version': '1.0',
 'status': 'proposed-standard',
 'levels': [{'level': 0, 'name': 'platform'},
            {'level': 1, 'name': 'governance'},
            {'level': 2, 'name': 'session'},
            {'level': 3, 'name': 'context'},
            {'level': 4, 'name': 'user'},
            {'level': 5, 'name': 'external'}],
 'unsignedDefaults': {'user': 4, 'external': 5},
 'signatureDefaults': {'trustLevel': 2, 'priority': 50},
 'topologyOrder': ['A', 'B', 'C'],
 ...
 'requiredGates': {'A': [],
                   ...
                   'C': ['pre-inference',
                         ...
                         'mcp-dispatch',
                         'server-output']},
 'trustReasonCodes': ['UNAUTHORIZED_TRUST', 'ENGINE_ISOLATION_UNSUPPORTED']}
