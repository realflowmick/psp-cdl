...
Status: **experimental reusable library**. CDL declaration/schema transport, inheritance with origins, finite deterministic policy evaluation and enforcement-gate checks. Normative tables ship inside the package.
...
License: Apache-2.0; bundled normative tables: CC0-1.0. Founding sponsor: RealflowCloud, Inc.
