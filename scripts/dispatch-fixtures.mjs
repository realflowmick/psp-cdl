...
export async function fixture(settings={}) {
  ...
  const coordinator=new OwnerCoordinator(),store=new WorkflowStore(backend,{resumeSecret:new Uint8Array(32).fill(7),authorizePersistence:()=>!flags.denyPersistence,coordinator,durableTurns:!!flags.durableTurns,promptRefresh:!!flags.promptRefresh,redirectTurns:!!flags.redirectTurns});
