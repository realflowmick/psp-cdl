...
if(options.mode==='fixture') {
  ...
  const store=new WorkflowStore(backend,{resumeSecret:secret,durableTurns:!!options.durableTurns,promptRefresh:!!options.promptRefresh,redirectTurns:!!options.redirectTurns,scopedTurns:!!options.scopedTurns,authorizePersistence:async()=>{
    if(options.barrier) {
