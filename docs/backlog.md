...
CDL-002 tests lexical tokenization already described by CDL sections 4.2/4.4; its
earlier classification as blocked on #34 was too broad. No parser proposal is
adopted. A uses a scripted provider control; C uses separate proxy and governed
server processes. The full-conformance command still exits 2; normative review,
semantic effectiveness testing and the M6 gates remain separate work.
