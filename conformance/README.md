...
The [requirement review](../specs/reviews/PSP-CDL-REVIEW-0.1.md) audits all 443 uppercase RFC keyword occurrences and retains explicit blocked/unimplemented obligation status; extraction is not conformance. All five seed vectors are draft expectations pending review; no adapter executes them yet. The harness reports inventory separately and exits 2 for an attempted unimplemented run. Blocked, unsupported, skipped, and error outcomes must never become passes.
